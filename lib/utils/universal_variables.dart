...
class UniversalVariables {
  static final Color blueColor = Color(0xff7768e5);
  ...
  static final Color lightBlueColor = Color(0xff353688  );
  static final Color separatorColor = Color(0xff272c35);

  static final Color gradientColorStart = Color(0xff7768e5);
  static final Color gradientColorEnd = Color(0xff353688);
